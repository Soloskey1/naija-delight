// Helper function to format currency as Nigerian Naira
    ...
    container.innerHTML = cart.map((item, index) => `
        <div class="flex items-center justify-between p-4 border-b last:border-b-0">
            <div class="flex-1">
                ...
                <p class="text-amber-700 font-medium">${formatNaira(item.price)}</p>
            </div>
            <div class="flex items-center space-x-3">
                <button onclick="changeQty(${index}, -1)" class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 transition">-</button>
...
function updateTotals(total) {
    // UPDATED: Standardized formatting for the summary section
